<?php
	...
	$gplus_black_icon_url = get_option('of_gplus_black_icon');
...
<?php if ($gplus_icon_url) { ?>
	<li class="gplus_icon"><a title="Google+" href="<?php echo $gplus_icon_url ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/icons/google-plus.png" alt="Google+"></a></li><?php } ?>
	
	<?php if ($gplus_black_icon_url) { ?>
	<li class="gplus_black_icon"><a title="Google+" href="<?php echo $gplus_black_icon_url ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/icons/google-plus-black.png" alt="Google+"></a></li><?php } ?>

	<?php if ($dribbble_icon_url) { ?>
	<li class="dribbble_icon"><a title="Dribbble" href="<?php echo $dribbble_icon_url ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/icons/dribbble.png" alt="Dribbble"></a></li><?php } ?>
...
<?php if ($github_icon_url) { ?>
	<li class="github_icon"><a title="GitHub" href="<?php echo $github_icon_url ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/icons/github.png" alt="GitHub"></a></li><?php } ?>
