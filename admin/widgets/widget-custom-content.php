...
/*
	...
	function of_Custom_Content_Widget() {
		...
		$widget_ops = array(
			...
			'description' => __('A widget that displays images, videos and HTML content.', 'of_custom_content_widget')
		);
		...
		$this->__construct( 'of_custom_content_widget', __('# Custom Content', 'of_custom_content_widget'), $widget_ops, $control_ops );
...
//		$args['caller_get_posts'] = $instance['caller_get_posts'] ? '1' : '0';
		...
		<li class="of_custom_content_widget">
		...
		<?php if ( $display == 'the_content' ) : ?>
			...
			<section class="entry-summary of_custom_content_widget">
				...
				<?php if ($titlewidget) { ?><h3 class="widget-title"><?php echo $instance['title-widget']; ?></h3><?php } ?>
				...
				<iframe class="vimeo-player" src="<?php echo $vimeo_path ?>"></iframe>
				...
				<!-- Post content -->
				<h3 class="box-title"><a href="<?php echo $instance['link_to']; ?>"><?php echo $instance['title']; ?></a></h3>
				<p class="custom-widget-description"><?php echo do_shortcode( stripslashes( $instance['text_content_txt'] ) ); ?></p>

				<?php if($instance['link_to']) { ?>
				<div class="btn-container"><a href="<?php echo $instance['link_to']; ?>" class="btn btn--point-right">More</a></div>
				<?php } ?>
...
//			'title' => __( '', $this->textdomain ),
		...
		<div style="float:left;width:97%;">
			...
			<p><textarea style="width:103%;" id="<?php echo $this->get_field_id( 'text_content_txt' ); ?>" name="<?php echo do_shortcode( stripslashes( $this->get_field_name( 'text_content_txt' ) ) ); ?>" cols="60" rows="9"><?php echo do_shortcode( stripslashes( $instance['text_content_txt'] ) ); ?></textarea></p>
